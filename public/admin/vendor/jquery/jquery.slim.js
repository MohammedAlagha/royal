...
jQuery.extend( {
	...
	Deferred: function( func ) {
				...
				pipe: function( /* fnDone, fnFail, fnProgress */ ) {
					...
					return jQuery.Deferred( function( newDefer ) {
						jQuery.each( tuples, function( _i, tuple ) {
							...
							// deferred.progress(function() { bind to newDefer or newDefer.noty })
							...
							var that = this,
								...
								mightThrow = function() {
									...
									if ( isFunction( then ) ) {
										...
										// Special processors (noty) just wait for resolution
										if ( special ) {
											then.call(
												returned,
		...
		jQuery.each( tuples, function( i, tuple ) {
			...
			// deferred.noty = function() { deferred.notifyWith(...) }
